...
function registerProfileAggregateTest(): void {
  void it("returns the student profile aggregate with stable empty future sections", async () => {
...
function registerAdultCreateTest(): void {
  void it("creates an adult student with address and reads it through byId", async () => {
...
function registerMinorValidationTest(): void {
  void it("rejects a minor student without guardian using Portuguese-BR validation", async () => {
  ...
  void it("rejects a minor guardian without phone or email", async () => {
    await assert.rejects(
      caller().students.create({
...
function registerMinorGuardianTest(): void {
  void it("creates a minor with nested guardian sharing the same address", async () => {
    const created = await caller().students.create({
...
function registerUpdateContactTest(): void {
  void it("updates contact, address, guardian, and notes through aggregate procedures", async () => {

...
void describe("classes catalog API", () => {
  ...
  databaseIt("creates a regular class with generated portal name", async () => {
    await cleanClassDatabase();
  ...
  databaseIt("creates a personalized class with manual portal name", async () => {
    await cleanClassDatabase();
    await ensureTeacherUser();
  ...
  databaseIt("archives a class", async () => {
    await cleanClassDatabase();
    await ensureTeacherUser();
    const fixtures = await seedClassCatalogFixtures();
  ...
  databaseIt("clones a regular class for the next period preserving lineage", async () => {
    await cleanClassDatabase();
    await ensureTeacherUser();
    const fixtures = await seedClassCatalogFixtures();
...
async function createRegularFixture(fixtures: Awaited<ReturnType<typeof seedClassCatalogFixtures>>) {

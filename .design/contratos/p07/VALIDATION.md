...
- Tab/Enter permitem navegar pelos controles e abrir calendário; foco visível.
  Mobile real emulado de 375 × 812, sem overflow horizontal da página; criação concluída.
- Calendário comum de 120 parcelas: 120 entradas, área com 254 px de altura e 4.199 px de
  conteúdo; rolagem chega à parcela 120 em 31/12/2035. Botões continuam acessíveis.
...
o arquivo implementado foi restaurado antes dos checks finais.
...
- Unitários: domínio 108, validators 131 e web 123 aprovados.
...
- Typecheck dos quatro workspaces afetados aprovado.
